...
[Files]
Source: "F:\Prehistoric - C++\Visual Studio Projects\PrehistoricEngine\bin\Distribution-windows-x86_64\PrehistoricEditor\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
