...
{
	VkCommandPool VKUtil::copyCommandPool;

	void VKUtil::Init(VKDevice* device)
	{
		VkCommandPoolCreateInfo info = {};
		info.sType = VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO;

		if (vkCreateCommandPool(device->getDevice(), &info, nullptr, &copyCommandPool) != VK_SUCCESS)
		{
	...
	void VKUtil::GenerateMipmaps(VKDevice* device, VkImage image, VkFormat format, uint32_t width, uint32_t height, uint32_t mipLevels)
	{
